...
const Navbar = () => {
  ...
  return (
    <div className="flex flex-wrap justify-between md:items-center text-white p-2 bg-slate-700">
      <div className="flex wrap justify-between md:items-center"> <img className="w-36" src={logo} alt='logo'></img> <span className="text-3xl font-bold">Compli-Tech</span></div>
       ...
       <a href ="#projects"> <li  className="text-md transition-all duration-300 p-1 md:p-0">Services</li> </a>
